      ...
      <div className="container mx-auto sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 right-0 flex items-center sm:hidden">
            {/* Mobile menu button*/}
            <DisclosureButton onClick={() => setIsOpen(!isOpen)} /* Toggle the panel */ className="group inline-flex items-center justify-center right-0 rounded-md p-2 mr-4 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
